...
void DessineUneLigneBusboucle(TlisteStation l, LTexture mySpriteArretBus, SDL_Renderer* gRenderer){
    TlisteStation maLigneBus = l, prochaineStation, prochainTroncon;
    TlisteStation firststation = maLigneBus;
    int idframe=0;
    int count = 0;
    if (ligneBusVide(maLigneBus)){
        SDL_Log("\n Erreur: ligne de bus sans station (maSDL.c)");
