...
TlisteStation *createNewListeFromFusion(TlisteStation *tabTlisteStation,int *taille, int l1 , int l2); //on souhaite CREER une nouvelle liste sans modifier l1 et l2
TlisteStation Suppstation(TlisteStation ligneenposition, int n);
